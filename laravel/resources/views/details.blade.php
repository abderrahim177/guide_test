          ...
          <div class="bg-white rounded-3xl overflow-hidden border border-slate-100 shadow-sm hover:shadow-md transition-all grid grid-cols-1 md:grid-cols-12">
            ...
            <div class="md:col-span-7 p-6 flex flex-col justify-between">
              ...
              <div class="flex items-center justify-between mt-6 pt-4 border-t border-slate-100">
                ...
                <a href="{{ route('detaile_place', ['id' => $program->region?->id]) }}"
                  class="bg-black inline-flex items-center gap-2 px-5 py-2.5 text-xs font-semibold tracking-wide text-forest-700 text-white rounded-xl border border-forest-100 hover:border-transparent shadow-sm   group">
                  <span>Show Details</span>
                  <i class="fa-solid fa-chevron-right text-[9px] transition-transform duration-300 group-hover:translate-x-1"></i>
                </a>
              </div>
