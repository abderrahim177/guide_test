        ...
        <div className="md:w-1/2 relative min-h-[250px] md:min-h-full flex flex-col justify-between p-8 text-white overflow-hidden bg-emerald-950">
          ...
          <div className="relative z-10 my-auto space-y-3 py-6">
            ...
            <p className="text-slate-300 text-xs font-normal leading-relaxed max-w-xs">
              Accédez à des guides locaux experts, louez du matériel
              professionnel et explorez le Maroc comme jamais auparavant.
            </p>
          </div>
          ...
          <div className="relative z-10 flex items-center gap-4 text-slate-300 text-xs pt-2 border-t border-white/10">
            <span className="flex items-center gap-1.5">
              <i className="fa-solid fa-shield-check text-amber-400"></i> 100%
              Sécurisé
            </span>
            <span>•</span>
            <span className="flex items-center gap-1.5">
              <i className="fa-solid fa-leaf text-amber-400"></i> Eco-Friendly
            </span>
          </div>
        </div>
          ...
          <div className="max-w-sm mx-auto w-full space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full font-semibold py-3 rounded-xl text-xs transition-all shadow-md mt-2 cursor-pointer flex items-center justify-center gap-2 ${
                  loading
                    ? "bg-emerald-950/80 text-white/80 cursor-not-allowed shadow-none"
                    : "bg-emerald-800 hover:bg-emerald-900 active:scale-[0.99] text-white shadow-emerald-900/10"
                }`}
              >
                {loading ? (
                  <>
